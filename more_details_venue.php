                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION["username"]))
                                    {
                                        ...
                                        if(isset($_COOKIE[$cookie_name]) && ($_COOKIE[$cookie_name])=="set") {             
                                            ...
                                            echo "<button class=\"bkmrk-unset\" onclick=\"document.location.href='removebookmarks.php?id=$id&name=Venue&str=$string'\"><img src=\"images/bookmark.png\"/></button>";                                            
                                        }
                                        else{
                                            //unset($_COOKIE[$cookie_name]);
                                            
                                            echo "<button class=\"bkmrk-set\" onclick=\"document.location.href='addtobookmarks.php?id=$id&name=Venue'\"><img src=\"images/bookmark.png\"/></button>";                                     
                                        }
